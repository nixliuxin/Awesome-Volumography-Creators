...
|-----------|-------------|
| **Beyond the Camera** | Moving from capturing 2D projections to capturing the essence of volumes and spatial experiences |
| **The Next General Medium** | Just as photography captured the moment and cinema captured time, Volumography captures reality as a navigable, immersive experience |
